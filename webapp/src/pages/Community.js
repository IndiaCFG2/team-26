...
function Random() {
    ...
    return <span style={{marginLeft:"10px"}}>{randomNumber} likes</span>
        ...
        <div className="container">
            <h1 style={{margin:"20px 0"}}>Community Forum</h1>
            {
                ...
                (   <>
                    ...
                    <div>
                        {posts && posts['posts'] && posts['posts'].map((p,i)=>
                            <div className="posts">
                                <div style={{display:"flex", alignItems:"center", justifyContent:"space-between"}}>
                                    <div style={{display:"flex", alignItems:"center", marginBottom:"20px"}}>
                                        ...
                                        { (i==0 || i==1) && <div style={{background:"#77dd77", padding:"8px 12px", borderRadius:"10px", marginLeft:"30px", marginTop:"-20px", fontSize:"0.8em"}}>New</div>}
                                    </div>
                                    <Broadcast />
                                </div>
                                <div>{p['content']}</div>
                                ...
                                }
                                {
                                    p['img'] && 
                                        <img
                                        style={{margin:"40px 0", height:"400px", width:"600px", borderRadius:0}}
                                        src={p['img']}
                                    />
                                }
                                <br/><br/>
                                {p['url'] && <a href={p['url']} style={{paddingTop:"80px"}}>{"View More Resource"}</a>}
